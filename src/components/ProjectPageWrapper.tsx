    ...
    if (!authLoading && user) {
      const getProjectData = async () => {
        ...
        if (docSnap.exists()) {
          ...
          // 【重要】古いデータ形式でもクラッシュしないように安全対策を強化
          setStage1Data({
          ...
          {stage2Data && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul>
                  <li>**特徴:** {stage2Data.productElements.features}</li>
                  <li>**メリット:** {stage2Data.productElements.benefits}</li>
                  <li>**実績:** {stage2Data.productElements.results}</li>
                  <li>**権威性:** {stage2Data.productElements.authority}</li>
                  <li>**オファー:** {stage2Data.productElements.offer}</li>
                </ul>
              </div>
              <div>
